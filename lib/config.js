...
export const CONFIG = {
  groom: {
    ...
    mama: "Bhacha of Neminath and Babasab Magadum"
  },
  bride: {
  ...
  familiesLine: "Bankapure · Magadum · Khot · Tirth · Kallimani · Ruge  · Sangave · Gat · Patil ",
  hashtag: "#AkshayWedsShraddha",

  /* वडीलधारी मंडळी — the elders whose blessings the day rests on.
     "Mama" is the mother's brother; थोरले = elder, धाकटे = younger. */
  elders: [
    { name: "Babasab Magadum", rel: "थोरले मामा", relEn: "elder mama" },
    { name: "Neminath Magadum", rel: "धाकटे मामा", relEn: "younger mama" },
    { name: "Ravasab Khot", rel: "", relEn: "" },
    { name: "Balasaheb Teerth", rel: "", relEn: "" },
  ],
  eldersLine: "वडीलधारी मंडळी",
  eldersLineEn: "With the blessings of our elders",
  eldersNote: "…and the entire Teerth and Khot families",

  /* The cousins — the ones who'll actually run the day. */
  cousins: ["Nikhil", "Sammed", "Nithin", "Darshan", "Sandesh", "Sujit", "Aishwarya", "Priya", "Rohit", "Arihant"],
  seniorCousins: ["Mahaveer", "Pratibha", "Swapnil (K)", "Saarika", "Sachin", "Sujata", "Sonali",
    "Nikhil", "Amruta", "Anant", "Pallavi", "Swapnil (M)", "Prashant", "Praveen",
    "Ujwala", "Nirmala", "Pranita"],
...
export const GUIDE = {
  pravaas: [
    ...
    ["Train", "Gataprabha / Kudchi and Miraj are the usable railheads; road the rest of the way."],
