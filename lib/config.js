...
export const CONFIG = {
  ...
  remembrance: [
    ...
    "कै. श्री. इंदिराबाई कल्लप्पा बंकापुरे · Late Smt. Indirabai Kallappa Bankapure",
  ...
  seniorCousins: ["Mahaveer", "Pratibha", "Swapnil (K)", "Sachin", "Sujata", "Sonali", "Nikhil", "Amruta", "Anant", "Pallavi", "Swapnil (M)", "Prashant", "Praveen", ],
