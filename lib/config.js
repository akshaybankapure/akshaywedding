...
export const CONFIG = {
  ...
  cousins: ["Nikhil", "Sammed", "Nithin", "Darshan", "Sandesh", "Sujit", "Aishwarya", "Priya", "Rohit", "Arihant","Nikhil"],
  seniorCousins: ["Mahaveer", "Pratibha", "Swapnil (K)", "Saarika", "Sachin", "Sujata", "Sonali", "Nikhil", "Amruta", "Anant", "Pallavi", "Swapnil (M)", "Prashant", "Praveen", "Ujwal", "Praneeta" ],
